	...
	<div id="bootstrap-wizard-1" class="">
		<div class="form-bootstrapWizard">
			<ul class="bootstrapWizard form-wizard">
				...
				<li data-target="#step3">
					<a href="#tab3" data-toggle="tab"> <span class="step">3</span> <span class="title">Clinic Setup</span> </a>
				</li>
		...
		<div class="tab-content">
					...
					<div class="col-sm-12">
						<div class="form-group has-error">
							<div class="input-group">
								...
								<input class="form-control input-lg" placeholder="email@address.com" type="text" name="email" id="email" aria-required="true" aria-describedby="email-error" aria-invalid="true">

							</div><span id="email-error" class="help-block">We need your email address to contact you</span>
						</div>
					...
					<div class="col-sm-6">
						<div class="form-group has-error">
							<div class="input-group">
								...
								<input class="form-control input-lg" placeholder="First Name" type="text" name="fname" id="fname" aria-required="true" aria-describedby="fname-error">

							</div><span id="fname-error" class="help-block">Please specify your First name</span>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group has-error">
							<div class="input-group">
								<span class="input-group-addon"><i class="fa fa-user fa-lg fa-fw"></i></span>
								<input class="form-control input-lg" placeholder="Last Name" type="text" name="lname" id="lname" aria-required="true" aria-describedby="lname-error">

							</div><span id="lname-error" class="help-block">Please specify your Last name</span>
						</div>
					</div>
				</div>
			...
			<div class="tab-pane" id="tab3">
				<br>
				<h3><strong>Step 3</strong> - Clinic Setup</h3>
...
<script type='text/javascript'>
	...
	$(document).ready(function()
	{
		...
		loadScript(BASE_URL+"js/plugin/fuelux/wizard/wizard.min.js", function(){
			loadScript(BASE_URL+"js/plugin/bootstrap-wizard/jquery.bootstrap.wizard.min.js", wizard_form);
		});
